...
![image](assets/image-20251102104910-povdkg8.png "瀑布模型")
...
![image](assets/image-20251102105245-1drxuts.png "螺旋模型")

它与瀑布模型的不同是在需求分析到编码环节都进行风险分析，评估方案后才进入下一级产品

![image](assets/image-20251102110024-mvcffwc.png "螺旋模型")
...
![image](assets/image-20251102111052-ar8at9e.png "增量模型")

可能先上线一部分的功能 / 模块，后续再进行完善，上线顺序可能是 模块1 -> 功能1 -> 功能2 -> 功能3 -> 功能4 -> 模块2

### 迭代模型

![image](assets/image-20251102111456-fmja664.png "迭代模型")
...
![image](assets/image-20251102114531-7hcr4dj.png)

‍

# 软件测试

**软件测试的最终目的是验证产品<u><strong>==**特性**==</strong></u>是否满足客户需求~**
...
![image](assets/image-20251102115130-wpxwf40.png "软件生命周期")

软件的生命从需求分析就开始了，一直到上线维护

软件测试的生命周期也从需求分析开始，虽然说在软件声明周期内测试是排在编码之后，但是软件测试的内容从需求分析就开始了，故说 <u><strong>==软件测试贯穿于整个软件的生命周期！==</strong></u>

![image](assets/image-20251102115153-48xy6bk.png "软件测试贯穿整个软件的生命周期")
...
![image](assets/image-20251102102442-x94ywwp.png)
...
![image](assets/image-20251102103915-0fdhavz.png)
