+++
date = '2025-12-15T00:47:22+08:00'
draft = true
title = '🪶 Git命令大全'
categories = "Git"
+++
...
![Git仓库结构](assets/Gemini123.png)

# 添加文件

​`git add .`表示添加所有在工作区的文件至暂存区
...
![](assets/image-20251119212943-wvcvc93.png)

高亮部分就是每次提交的id，用`git reflog`命令也能得到，且id更加简洁

![](assets/image-20251119215310-0affl22.png)
...
![](assets/image-20251105003923-cmv4tgy.png "版本回退")
...
![](assets/image-20251109015150-ieem3qz.png)
...
1. ​`git merge <branchName>`（Fast-forward模式）
    ...
    ![](assets/image-20251118000559-ea8sdim.png)
    ...
    ![](assets/image-20251118003722-spucr2i.png "Fast-forward分支情况")
...
2. ​`git merge --no-ff -m "新提交的信息" <branchName>`
    ...
    ![](assets/image-20251118004848-3eh6v98.png "No-Fast-forward分支情况")
...
![](assets/image-20251118002835-0l81g4z.png "合并冲突")

此时的分支情况

![](assets/image-20251118003231-8009p5k.png "合并冲突分支情况")

在git中也支持提交线的可视化图标，使用`git log --graph --abbrev-commit`，如图所示

![](assets/image-20251118003527-w7w7uap.png)
...
![](assets/image-20251119212250-66ug4cp.png)
...
- 干活修改的内容都应该在dev分支上，等到某个时候迎来版本更新，再把dev分支合并到master上，在master分支上发布新版本
  ...
  ![](assets/image-20251118011057-v5s8oxu.png)
...
![](assets/image-20251119205319-8qfuplj.png "dev看不到修改bug的代码")

解决这个问题的一个好的建议是：最好在自己的分支上合并下`master`​，再让`master`​去合并`dev`​，这样做的目的是有冲突可以在本地分支解决并进行测试，而不影响`master`，这样做此时的状态为：

![](assets/image-20251119210205-6stwel5.png)

![](assets/image-20251119210308-2c4655f.png)

具体操作如下，在第一步中不出意外遇到了冲突

![](assets/image-20251119210545-wdaw7ch.png)

手动修改后别忘了提交，然后切回到`master`​分支上，再合并`dev`​，此时`master`​上就既有修改后的代码，也有`dev`上提交的新代码且不冲突了

![](assets/image-20251119211401-fm7zl8x.png)
...
![](assets/image-20251124165733-gfaiycq.png)
...
![](assets/image-20251124172126-rwiu879.png)

然后修改在`.gitignore`​上写上要忽略的文件类型 / 文件后缀名，修改命令为`vim`​，如`vim .gitignore`

![](assets/image-20251124173342-9h0v7bn.png)
...
![](assets/image-20251205012941-z67yes7.png)
